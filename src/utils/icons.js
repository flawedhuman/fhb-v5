...
export function typeIcon(type, color) {
    const paths = {
      thought: 'M4 20h16 M12 20c.3-3.5-.4-6 .2-9.3 M9 13c-1.6-.6-2.6-2-2.4-3.6 1.7.3 2.8 1.7 2.4 3.6 M12.4 11c1.6-.7 2.4-2.2 2-3.8-1.7.4-2.6 1.9-2 3.8',
